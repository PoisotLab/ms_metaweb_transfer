...
> some notes/words here on the in-and-outs of ML to demystify it a bit
...
> Paragraph listing this, can 'lift' (within reason) from Maiorano
...
> Some 'multi-models'? i.e. having a look at alternative TDs. More importantly
> moving away from the term trait altogether and using latent variable (or a
...
> I mean you didn't mention the amazing, nay I say perfection that is figure one
> so...
