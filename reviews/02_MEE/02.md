...
> An excellent question and something we have addressed now in-text as well (~l.
> 123 in .md) In short, we don't necessarily need to use one super tree and
> (*e.g.* for bipartite webs) two distinct trees can be used. Trait
